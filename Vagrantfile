Vagrant.configure("2") do |config|
  ...
  config.vm.define :streamaprov do |streamaprov|
    ...
    streamaprov.vm.network :private_network, ip: "192.168.50.3"
    streamaprov.vm.provision "file", source: "~/finalAprov/streama.service", destination: "$HOME/"
  ...
  config.vm.define :firewallaprov do |firewallaprov|
    ...
    firewallaprov.vm.network :private_network, ip: "192.168.100.3"
    firewallaprov.vm.network :private_network, ip: "192.168.50.4"
